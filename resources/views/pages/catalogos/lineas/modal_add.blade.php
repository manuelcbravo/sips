<x-modal.modal id="ModalLineas" size="modal-sm" nombretitulo="">
    <x-slot name="titulo"> Línea </x-slot>
    <x-slot name="body">
        <form class="js-validate needs-validation" novalidate="" data-name="FormUsuarios" id="FormUsuarios" method="POST" >
            ...
            <div class="row">
                <div class="col-sm-6">
                    <x-form.input tipo="text" id="linea" titulo="Línea" holder="" required="true" options='' validationclass='' error=''></x-form.input>
                </div>
                <div class="col-sm-6">
    ...
    @push('js_modulo')
        $("table").on("click","[data-bs-target='#ModalLineas']",function(){
