<x-modal.modal id="ModalSucursal" size="modal-xl" nombretitulo="">
    <x-slot name="titulo"> Sucursal </x-slot>
    <x-slot name="body">
    ...
    @push('js_modulo')
        ...
        const get = (data) =>{
            ...
            $.each(data.posts, function(index, value) {
                ...
                }else if(index === 'id_encargado'){
                    const selecte = tom_select.find(element => element.inputId == index);
                    selecte.setValue([value])
                }else{
                    $('#ModalSucursal #'+index).val(value);
                }
            });
        ...
        $("body").on('click', '.cp-b', function(e) {
            let cp_id = $('#ModalSucursal #cp').val()
            if(cp_id.length == 5){
                ...
                success: function(data) {
                    ...
                    $.each(data.results, function(index, value) {
                        if(value.components['ISO_3166-1_alpha-2'] == 'MX'){
                            ...
                            $("#ModalSucursal #latitud").val(lat_geo);
                            $("#ModalSucursal #longitud").val(long_geo);
        ...
        $("#ModalSucursal #latitud").val(event.latLng.lat());
        $("#ModalSucursal #longitud").val(event.latLng.lng());
        });
